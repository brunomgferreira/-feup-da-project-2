#ifndef FEUP_DA_PROJECT_2_GET_NODES_FILE_PATH_STATE_H
#define FEUP_DA_PROJECT_2_GET_NODES_FILE_PATH_STATE_H
...
class GetNodesFilePathState : public State {
private:
    State* backState;
...
public:
    ...
    */
    GetNodesFilePathState(State* backState, function<void(App*)> nextStateCallback);
...
#endif //FEUP_DA_PROJECT_2_GET_NODES_FILE_PATH_STATE_H

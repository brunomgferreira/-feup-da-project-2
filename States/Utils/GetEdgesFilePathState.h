#ifndef FEUP_DA_PROJECT_2_GET_EDGES_FILE_PATH_STATE_H
#define FEUP_DA_PROJECT_2_GET_EDGES_FILE_PATH_STATE_H
...
class GetEdgesFilePathState : public State {
private:
    State* backState;
...
public:
    ...
    */
    GetEdgesFilePathState(State* backState, function<void(App*)> nextStateCallback);
...
#endif //FEUP_DA_PROJECT_2_GET_EDGES_FILE_PATH_STATE_H

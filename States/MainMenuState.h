#ifndef FEUP_DA_PROJECT_2_MAIN_MENU_STATE_H
#define FEUP_DA_PROJECT_2_MAIN_MENU_STATE_H


#include "State.h"

/**
* @brief Class representing the main menu state of the program.
*/
...
#endif //FEUP_DA_PROJECT_2_MAIN_MENU_STATE_H
